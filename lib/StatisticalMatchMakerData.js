...
stat.dimensionsHandlers.set("http://registry.easytv.eu/common/display/screen/enhancement/font/color", new Color(new Numeric(242.0, 7.0, -1.0 ),new Numeric(248.0, 16.0, -1.0 ),new Numeric(248.0, 36.0, -1.0 )));
stat.dimensionsHandlers.set("http://registry.easytv.eu/common/display/screen/enhancement/background", new Color(new Numeric(236.0, 0.0, -1.0 ),new Numeric(231.0, 32.0, -1.0 ),new Numeric(236.0, 71.0, -1.0 )));
...
stat.dimensionsHandlers.set("http://registry.easytv.eu/application/cs/cc/subtitles/fontColor", new Color(new Numeric(216.0, 3.0, -1.0 ),new Numeric(251.0, 30.0, -1.0 ),new Numeric(253.0, 19.0, -1.0 )));
stat.dimensionsHandlers.set("http://registry.easytv.eu/application/cs/cc/subtitles/backgroundColor", new Color(new Numeric(243.0, 18.0, -1.0 ),new Numeric(243.0, 73.0, -1.0 ),new Numeric(205.0, 21.0, -1.0 )));
