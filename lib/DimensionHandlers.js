...
class Nominal extends Dimension {
	  ...
	  constructor(states, missingValue = -1, converter = null) {
		super(missingValue);
	    this._states = states;
...
class Numeric extends Dimension {
	  ...
	  constructor(max, min, missingValue = -1, converter = null) {
		super(missingValue);
...
class DoubleNumeric extends Numeric {
	  ...
	  constructor(max, min, missingValue = -1, converter = null) {
		super(max, min, missingValue, converter);
	  }
...
/**
 * Handler for non handling dimensions
 */
class Ignore extends Dimension {
