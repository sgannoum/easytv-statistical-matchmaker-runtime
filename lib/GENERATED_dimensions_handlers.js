...
stat.contextHandlers.set("http://registry.easytv.eu/context/device/screenSize/xdpi", new IntegerNumeric(640.0, 150.0, -1.0, (x) => {return parseInt(x, 10);}))
stat.contextHandlers.set("http://registry.easytv.eu/context/device/screenSize/ydpi", new IntegerNumeric(640.0, 150.0, -1.0, (x) => {return parseInt(x, 10);}))
stat.contextHandlers.set("http://registry.easytv.eu/context/device/screenSize/diameter", new DoubleNumeric(31.0, 2.5, -1.0))
stat.contextHandlers.set("http://registry.easytv.eu/context/device/screenSize/densityValue", new DoubleNumeric(0.75, 4.0, -1.0))
